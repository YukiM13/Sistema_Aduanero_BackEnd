...
namespace SIMEXPRO.DataAccess.Repositories.Gral
{
    public class CargosRepository : IRepository<tbCargos>
    {
        ...
        public RequestStatus Insert(tbCargos item)
        {
            ...
            parametros.Add("@carg_FechaCreacion", item.carg_FechaCreacion, DbType.DateTime, ParameterDirection.Input);
        ...
        public RequestStatus Update(tbCargos item)
        {
            ...
            parametros.Add("@carg_FechaModificacion", item.carg_FechaModificacion, DbType.DateTime, ParameterDirection.Input);
